 ...
 */
final class Version20220701104017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE catalog (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT DEFAULT NULL, lang_id INT DEFAULT NULL, filename VARCHAR(255) NOT NULL, origin_filename VARCHAR(255) NOT NULL, byte_size INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_1B2C32473C0BE965 (filename), INDEX IDX_1B2C3247A23B42D (manufacturer_id), INDEX IDX_1B2C3247B213FA4 (lang_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE parse_queue (id INT AUTO_INCREMENT NOT NULL, lang_id INT DEFAULT NULL, manufacturer_id INT DEFAULT NULL, origin_filename VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, text LONGTEXT DEFAULT NULL, status ENUM(\'new\', \'parsing\', \'success\', \'failed\', \'duplicated\'), exception_text LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_CA83A06FB213FA4 (lang_id), INDEX IDX_CA83A06FA23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
